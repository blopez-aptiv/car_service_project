...
carro_modelo = namespace.inherit('carro',
{
    "tipo": fields.Integer(description='1.carro, 2. motocicleta, 3.automovil de 3 ruedas',
                          required=True),
...
class obtener_vehiculo(Resource):
    @namespace.response(code=200, description='consulta exitoso')
    @namespace.response(code=400, description='Peticion invalida')
    @namespace.response(code=500, description='Error interno en el servidor')
    def get(self):
...
{
    "role_id": fields.Integer(description='1.empleado, 2. cliente',
                          required=True),
...
{
    "id_cliente": fields.Integer(description='',
                          required=True),
